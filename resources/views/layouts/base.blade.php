...
<head>
	...
	<title>HBS Consultores Turisticos</title>
...
<main>
	...
	<div class="container">
		...
		<section id="services" class="section mt-5 mb-5">
			...
			<!-- Section heading -->
			<h3 class="text-center mb-5 mt-5 pt-5 font-up font-bold grey-text-2 wow fadeIn" data-wow-delay="0.2s">Services</h3>

			<!-- Section description -->
			<p class="section-description pb-4 mt-3 wow fadeIn" data-wow-delay="0.2s">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>

			<!-- Grid row -->
			<div class="row text-center smooth-scroll">

				<!-- Grid column -->
				<div class="col-lg-4 col-md-12 mb-1 wow fadeIn" data-wow-delay="0.4s">

					<!-- Featured image -->
					<div class="view overlay hm-white-slight z-depth-1 z-depth-2">
						<img src="https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%2812%29.jpg">
					</div>

					<!-- Excerpt -->
					<div class="card-body">
						<a href="" class="light-green-text-2"><h5><i class="fa fa-users"></i> Public Relations</h5></a>
						<h3>First title goes here</h3>
						<p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque.</p>
						<a href="#details" class="btn btn-rounded btn-light-green-2"><i class="fa fa-clone left"></i>Learn more</a>
					</div>
				...
				<!-- Grid column -->
				<div class="col-lg-4 col-md-6 mb-1 wow fadeIn" data-wow-delay="0.4s">

					<!-- Featured image -->
					<div class="view overlay hm-white-slight z-depth-1 z-depth-2">
						<img src="https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%289%29.jpg">
					</div>

					<!-- Excerpt -->
					<div class="card-body">
						<a href="" class="light-green-text-2"><h5><i class="fa fa-slack"></i> Branding</h5></a>
						<h3>Second title goes here</h3>
				...
				<div class="col-lg-4 col-md-6 mb-1 wow fadeIn" data-wow-delay="0.4s">
					...
					<!-- Featured image -->
					<div class="view overlay hm-white-slight z-depth-1 z-depth-2">
						<img src="https://mdbootstrap.com/img/Photos/Horizontal/Work/4-col/img%20%2814%29.jpg">
					</div>

					<!-- Excerpt -->
					<div class="card-body">
						<a href="" class="light-green-text-2"><h5><i class="fa fa-instagram"></i> Social Media</h5></a>
						<h3>Third title goes here</h3>
						...
						<a href="#details" class="mb-4 btn btn-rounded btn-light-green-2"><i class="fa fa-clone left"></i>Learn more</a>
					</div>
...
<footer class="page-footer center-on-small-only">
	...
	<div class="container-fluid">
		...
		<div class="row mb-2 wow fadeIn" data-wow-delay="0.3s">
			...
			<div class="col-md-12 text-center smooth-scroll">
				...
				<!-- Title -->
				<h2 class="mb-3 bold-font">Meet for coffee</h2>
				<!-- Description -->
				...
				<!-- Reservation button -->
				<a href="#contact" data-offset="100" class="btn btn-rounded btn-light-green-2">Book dates</a>
	...
	<div class="footer-copyright wow fadeIn" data-wow-delay="0.3s">
		<div class="container-fluid">
			© 2016 Copyright: <a href="https://www.MDBootstrap.com" rel="nofollow"> MDBootstrap.com </a>
