<div class="streak streak-photo streak-md hm-green-strong-2" style="border-bottom: 2px solid #009688;background-image: url({{ asset("assets/media/img/creative.jpg") }});">
